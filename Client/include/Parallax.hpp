...
namespace MyComponents
{
        ...
        void drawing_shape(Registry &r)
        {
            ...
            for (size_t i = 0; i < drawable.size() && i < positions.size(); ++i)
            {
                ...
                if (draw && pos)
                {
                    ...
                    std::cout << "touchable = " << bull.value().touchable << std::endl;
    ...
    public:
        ...
        DrawEnemySystem(sf::RenderWindow &window, MyLib &lib) : _win(window), _lib(lib) {
            fscore.loadFromFile("menu/pol.TTF");
            tscore.setFont(fscore);
            tscore.setPosition(0, 500);
            tscore.setScale(1, 1);
        }
...
class MoveEnemy
    ...
    public:
        Menu(sf::RenderWindow &_window, MyLib &lib, sf::IntRect _rect, sf::IntRect _rect2, sf::IntRect _rect3, sf::IntRect _rect4, sf::IntRect _rect5, sf::IntRect _rect6) : window(_window), _lib(lib), rect(_rect), rect2(_rect2), rect3(_rect3), rect4(_rect4), rect5(_rect5), rect6(_rect6)
        {
            ...
            bclick.loadFromFile("menu/click.ogg");
            ...
            scredits.setPosition(1366/1.5, 0);
            tcredits.loadFromFile("menu/credits.png");
            scredits.setTexture(tcredits);
            scredits.setScale(1, 1);
        ...
        void drawMenu()
        {
            ...
            if (n == 5)
            {
                if (b >= -768)
                    ...
                    b = 0;
            scredits.setPosition(1366/3.6, b);  
    ...
    private:
        ...
        sf::Sound sclick;
        std::vector<std::string> vec = {"EASY", "HARD"};
        sf::Time time;
        float seconds;
        sf::Clock clock;
        sf::Time time2;
